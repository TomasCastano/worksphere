...
const CreateSpaceCard = ({ open, setOpen, handleCreateSpace }) => {
    return (
        <>
        <div
            className="border-[2px] border-dashed border-gray-200 rounded-md bg-white w-80 p-4 flex flex-col justify-center items-center gap-2 cursor-pointer hover:bg-gray-100 transition-colors"
